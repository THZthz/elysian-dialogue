...
![screenshot](docs/images/Screenshot%202026-06-04%20130759.png)
...
- **Persistent world** in a graph database — characters, locations, objects, relationships, plots, and notes all survive across sessions
- **Hybrid search** combining dense, sparse, and cross-encoder reranking for world exploration through vector semantic search
- **Save and resume** with turn-level checkpoints
- **Terminal-first** — Markdown rendering, no web UI, focus put on storytelling quality for now
