...
2. Reverse-engineer — how many hints need to be planted beforehand for the revelation to hold?
3. Every hint must have a surface meaning — the audience reads the surface meaning on first viewing and reads the hidden line meaning on second viewing.
4. The hidden line's surfacing timing is typically at the climax or resolution section.

### Quantity Recommendation
1-2 hidden lines for feature-length works; 1-3 for series. Too many hidden lines make the story overly complex.