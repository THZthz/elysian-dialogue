## Pacing Planning (Director Level)

The director stage adds execution-layer refinement on top of the writer's established rhythm.

### What the Writer Stage Already Determined
- Each scene's plot density (loose / medium / tight)
- Each scene's emotional weight (light / medium / heavy)
- The general shape of the overall rhythm wave diagram

### What the Director Stage Determines
- Each scene's **shot density** (long takes vs fast cuts vs mixed)
- Each scene's **shot scale focus** (wide/long shots vs mid-shots vs close-ups)
- Each scene's **duration allocation** (what proportion of total runtime)
- **Transition strategy** between scenes (hard cut vs dissolve vs match cut vs music bridge)
...
On top of the writer's dual-track wave diagram, overlay director execution-layer information. The diagram adds shot density and shot scale focus as additional tracks to the writer's plot rhythm and emotional rhythm tracks.
