## Secondary Character & Ensemble Design

Secondary characters are not background decoration. Every character with dialogue should have a functional reason for existing.

### Four Functions of Secondary Characters

- **Mirror Character**: Reflects a facet of the protagonist. They walked a path the protagonist didn't take — "if the protagonist had made a different choice, they would become this person."
- **Catalyst Character**: An external force that drives the protagonist to change. Mentor, tempter, challenger.
- **Theme Character**: Embodies a particular position in the thematic argument. The B Story character usually serves this function.
- **Rhythm Character**: Provides comic relief or emotional variation. Their function is to give the audience a place to breathe during tense sections.
