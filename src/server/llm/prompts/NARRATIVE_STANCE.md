...
- **Camera as observing bystander**: Present but not intervening. Close to characters but maintaindistance. (Kore-eda)
...
- **Camera as an alien observing humans for the first time**: Everything "normal" receives estranging gaze. Fixed camera, geometric composition, slow, unsettling. (Lanthimos)
