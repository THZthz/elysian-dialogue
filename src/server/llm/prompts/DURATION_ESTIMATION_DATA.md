...
### By Narrative Action Type
| Narrative Purpose Type | Short Film Baseline | Notes |
|---|---|---|
| Advancement / Escalation | 2.5-3.5s | Fastest — events accelerating, shots also accelerate |
...
| Content Expression Amount | Short Film Baseline | Typical Scenario |
|---|---|---|
...
### Dialogue Impact on Shot Duration
Dialogue length affects shot duration, but speaking rate is not a fixed value — it is influenced by character personality, age, emotional state, and scene rhythm. The same 10-word line:
- Spoken by an impatient young person in an argument: ~1.5 seconds
- Spoken by a calm elderly person in reminiscence: ~5 seconds — with pauses, breathing, silence
- Spoken by a drunk character slurring: ~4 seconds — slow and unclear

When estimating dialogue duration, mentally "perform" the line — read it at the speed, pauses, and breathing pattern this character in this situation would use. The reading time is the minimum dialogue time the shot needs. Beyond dialogue time, add reaction time (the other character's pause after hearing, expression change).

### By Shot Scale
| Shot Scale | Short Film Baseline | Notes |
|---|---|---|
| Close-up / Extreme Close-up | 2-4s | Information concentrated, quick read |
| Mid-shot | 3-5s | Standard narrative scale |
| Wide shot | 4-5s | Need to scan environment |
| Extreme Wide / Distant | 5-7s | Need more time to feel the space |
| Scale-Changing Shot | 8-12s | Push/pull needs movement time |

### Shot Group Duration Reference
| Group Type | Shots in Group | Group Total Duration | Per-Shot Duration |
|---|---|---|---|
